...
<main class="main-content  mt-0">
	<div class="pt-5 m-3 page-header align-items-start min-vh-50 pb-11 border-radius-lg"
		style="background-image: url('<?= _WEB_ROOT ?>../resources/assets/admin/img/bg-blue.jpg');">
		<div class="container">
			<div class="row justify-content-center">
				<div class="mx-auto text-center col-lg-5">
					<h1 class="mt-5 mb-2 text-white">Chào mừng trở lại!</h1>
					<p class="text-white text-lead">Sử dụng miễn phí các biểu mẫu tuyệt vời này để đăng nhập hoặc tạo
						tài khoản mới trong dự án của bạn.</p>
				</div>
			</div>
		</div>
	</div>
			...
			<div class="mx-auto col-xl-4 col-lg-6 col-md-7">
				<div class="card z-index-0">
					...
					<div class="px-4 card-body">
						<form action="/admin/checkLogin" method="post" class="text-start">
							<div class="mb-3">
							...
							<div class="mb-3">
								<input type="password" class="form-control" name="password"
									placeholder="Nhập mật khẩu của bạn" aria-label="Password">
								<?= $error_password; ?>
							</div>
							...
							<div class="text-center">
								<a href="/admin/register" class="mt-2 mb-4 btn btn-white w-100">Đăng ký</a>
							</div>
							<div class="text-center">
