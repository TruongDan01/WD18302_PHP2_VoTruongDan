...
$title = Session::flash('error-title');
$error_title = !empty($title) ? '<div class="pt-2 text-danger font-weight-bold">* ' . $title . '</div>' : '';

$subject = Session::flash('error-subject');
$error_subject = !empty($subject) ? '<div class="pt-2 text-danger font-weight-bold">* ' . $subject . '</div>' : '';
...
$question = Session::flash('error-question');
$error_question = !empty($question) ? '<div class="pt-2 text-danger font-weight-bold">* ' . $question . '</div>' : '';
?>
