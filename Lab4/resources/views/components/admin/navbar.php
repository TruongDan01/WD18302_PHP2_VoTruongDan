                    ...
                    <ul class="navbar-nav  justify-content-end">
                            ...
                            <ul class="px-2 py-3 dropdown-menu dropdown-menu-end me-sm-n4"
                                ...
                                <li class="mb-2">
                                    <a class="dropdown-item border-radius-md" href="javascript:;">
                                        <div class="py-1 d-flex">
                                            <div class="my-auto">
                                                <img src="<?= _WEB_ROOT ?>./resources/assets/admin/img/team-2.jpg" class="avatar avatar-sm  me-3 "
                                                    alt="user image">
                                            </div>
                                ...
                                <li class="mb-2">
                                    <a class="dropdown-item border-radius-md" href="javascript:;">
                                        <div class="py-1 d-flex">
                                            <div class="my-auto">
                                                <img src="<?= _WEB_ROOT ?>./resources/assets/admin/img/small-logos/logo-spotify.svg"
                        ...
                        <li class="nav-item dropdown d-flex align-items-center">
                            <div class="avatar avatar-sm position-relative">
                                <img src="<?= _WEB_ROOT ?>./resources/assets/admin/img/team-1.jpg" alt="profile_image" class="w-100 border-radius-md">
                            </div>
                        </li>
                        </a>
                        </li>
