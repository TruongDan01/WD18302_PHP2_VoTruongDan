                        ...
                        <div class="d-lg-flex">
                            ...
                            <div class="my-auto mt-4 ms-auto mt-lg-0">
                                <div class="my-auto ms-auto">
                                    <a href="/admin/course/new" class="me-2 mb-0 btn btn-dark" target="_blank">
                                        ...
                                        <thead class="thead-light">
                                            <tr>
                                                ...
                                                <th class="text-xs" data-sortable="" style="width: 12.2613%;"><a
                                                        href="#" class="dataTable-sorter">Kỳ học</a></th>
                                                <th class="text-xs" data-sortable="" style="width: 10.0503%;"><a
                                                        href="#" class="dataTable-sorter">Đã đánh giá</a></th>
                                                <th class="text-xs" data-sortable="" style="width: 13.2663%;"><a
                                                        href="#" class="dataTable-sorter">Chưa đánh giá</a></th>
                                        ...
                                        <tbody>
                                            <?php foreach ($courses as $course) { ?>
                                                <tr>
                                                    <td>
                                                        <div class="d-flex">
                                                            ...
                                                            <img class="avatar avatar-md ms-3"
                                                                src="<?= _WEB_ROOT ?>../<?= $course['image'] ?>" alt="sofa">
                                                    ...
                                                    <td class="text-sm">
                                                        <?= $course['combined_class_names'] ?>
                                                    </td>
                                                    <td class="text-sm">
                                                        <?= $course['combined_teacher_names'] ?>
                                                    </td>
                                                    <td class="text-sm">
                                                        <?= $course['nameSemeste'] ?>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <span class="badge badge-danger badge-sm">
                                                            <?= $course['qty_not_feedback'] ?>
                                                        </span>
                                                    </td>
                                                    <td class="text-sm">
                                                        <a href="/admin/feedback/list?id=<?= $course['id'] ?>"><i
                                                                class="fas fa-eye text-dark" aria-hidden="true"></i>
                                                        </a>
                                                    </td>
                                                </tr>
                                            <?php } ?>
