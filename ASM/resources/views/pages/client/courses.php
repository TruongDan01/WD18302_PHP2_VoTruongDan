        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-3 text-center">
                <button type="submit" class="btn btn-light mt-2"
                    style="color: #ffff; background-color: #2e21df;">Lọc</button>
                <button type="reset" class="btn btn-light mt-2" style=" color: #ffff; background-color: #a5a5a5;">Đặt
                    lại</button>
            </div>
        </div>
    </div>
                    ...
                    <div class="course">
                        ...
                        <div class="course_footer d-flex flex-row align-items-center justify-content-start">
                            ...
                            <div class="course_mark course_free trans_200"><a
                                    href="/chi-tiet-mon-hoc?id=<?= $course['id'] ?>">Đánh giá</a></div>
                        </div>
                    </div>
                </div>
            <?php } ?>
